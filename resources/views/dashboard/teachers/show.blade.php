    ...
    <div class="container mt-5" dir="rtl">
        ...
        <div class="text-center mb-5">
            <h1 class="display-6 fw-bold text-success">
                <i class="fas fa-chalkboard-teacher me-2"></i> الملف الشخصي للأستاذ
            </h1>
            <p class="text-black">تفاصيل المعلومات الأساسية للأستاذ</p>
        </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <div class="bg-white p-3 rounded-3 shadow-sm">
                                {{ $user->teacher->circle->name ?? 'غير محدد' }}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 mt-4">
                        <div class="d-flex justify-content-between align-items-center">
                            <div class="order-2">
                                <a href="{{ route('admin.teachers.edit', $user->teacher->id) }}"
